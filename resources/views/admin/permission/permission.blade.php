...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            ...
            <form action="{{ route('admin.permissions.store_permisssion') }}" class="ajaxForm" method="post" enctype="multipart/form-data" novalidate>
                @csrf

                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="area_name">Permission Types</label>
                    ...
                    <div class="form-group col-md-6">
                        <label for="area_name">Permission </label>
                        <input type="text" class="form-control" parsley-trigger="change" data-parsley-required placeholder="Enter Permission name Type" value="" name="name" id="name">
                    </div>
                </div>    
